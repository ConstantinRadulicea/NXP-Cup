...
class SteeringWheel : protected SteeringServo
{
public:
	SteeringWheel(unsigned int servo_max_left_angle = 0, unsigned int servo_middle_angle = 90, unsigned int servo_max_right_angle = 180)
		: SteeringServo(servo_max_left_angle, servo_middle_angle, servo_max_right_angle)
	{
	...
	void setSteeringWheelAngleDeg(float steering_wheel_angle) {
		...
		steering_servo_angle = this->SteeringAngleToRawAngle_rad(steering_wheel_angle);
		this->setSteeringAngleDeg(steering_servo_angle);
...
private:
	...
	// negative angle: goinf left
	// wheels angle: [-48.946945; 59.711018], servo angle: [-65; 41]
	Point2D g_servo_position;
	Point2D g_arm_wheel_position;
	float g_servo_arm_circle_radius_mm;
	float g_arm_wheel_circle_radius_mm;
	float g_arm_wheel_angle_rad;

	float g_arm_wheel_angle_position_rad;
	float g_servo_rod_forward_angle_position_rad;
	float g_servo_rod_angle_position_rad;
	float g_arm_wheel_forward_angle_position_rad;
